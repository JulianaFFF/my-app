...
export default function BookDetailPage({ bookId }: BookDetailPageProps) {
  ...
  if (isLoading) {
    return (
      <div className="flex justify-center items-center min-h-screen">
        <div className="text-xl">Cargando detalles del libro...</div>
      </div>
    );
  }
  ...
  if (!book) {
    return (
      <div className="flex justify-center items-center min-h-screen">
        <div className="text-xl text-gray-600">Libro no encontrado</div>
      </div>
    );
  }
    ...
    <div className="container mx-auto px-4 py-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2">
            ...
            <div className="space-y-3 mb-6">
              ...
              <div className="flex items-center">
                <span className="font-semibold text-gray-700 w-32">Publicación:</span>
              ...
              {book.editorial && (
                <div className="flex items-center">
                  <span className="font-semibold text-gray-700 w-32">Editorial:</span>
                  <span className="text-gray-600">{book.editorial.name}</span>
                </div>
              )}
              
              {book.authors && book.authors.length > 0 && (
                <div className="flex items-start">
                  <span className="font-semibold text-gray-700 w-32">Autores:</span>
      ...
      <div className="bg-white rounded-lg shadow-md p-6">
        ...
        <div className="border-b pb-6 mb-6">
          <h3 className="text-lg font-semibold text-gray-700 mb-4">Agregar Review</h3>
        ...
        <div className="space-y-4">
          {book.reviews && book.reviews.length > 0 ? (
            ...
            <div className="text-center py-8 text-gray-500">
              <p>No hay reviews para este libro aún.</p>
              <p className="text-sm">¡Sé el primero en agregar un review!</p>
            </div>
          )}
        </div>
      </div>
